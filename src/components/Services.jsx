    ...
    <div class="py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
      <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
        ...
        <div class="mx-5 flex flex-col md:flex-row gap-4">
          <Link
            class="block rounded-xl bg-darkess bg-opacity-10 min-w-[31%] hover:bg-opacity-70 border border-principal p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            href="/accountant"
          >
